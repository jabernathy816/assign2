...
class team1cal2_ATS(unittest.TestCase):
   ...
   def test_cal2(self):
       ...
       assert "Logged In"
       time.sleep(5)
       elem = driver.find_element_by_xpath("/html/body/div/div[2]/div[1]/div[2]/table/tbody/tr[3]/td[1]/a").click()
       time.sleep(3)
       elem = driver.find_element_by_id("id_cust_name")
       elem.send_keys("b")
       elem = driver.find_element_by_id("id_service_category")
       elem.send_keys("test food tray")
       elem = driver.find_element_by_id("id_description")
       elem.send_keys("this is a test service decsription")
       elem = driver.find_element_by_id("id_location")
       elem.send_keys("test location")
